...
public class IntQueue2{
	...
	*/
	...
	// Utile nel caso in cui non è facile iterare, poichè non esponiamo la rappresentazione.
	public Iterator<Integer> iterator(){ // Interfaccia specifica una serie di comportamenti.
		modified = false;
		return new Iterator<Integer>(){ // Invocazione costruttore, tipo restituito, tonde per gli argomenti.
